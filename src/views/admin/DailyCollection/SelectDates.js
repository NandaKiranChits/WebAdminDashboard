    ...
    return (
        <>
            <div className="w-full lg:w-4/12 px-4">
                <SelectDate placeholder="Start date" onchange={(val)=>{collectionStore.setStartDate(val);}} />
            </div>
            <div className="w-full lg:w-4/12 px-2">
                <SelectDate placeholder="End date" onchange={(val)=>{collectionStore.setEndDate(val);}}/>
            </div>
        </>
    )
})
