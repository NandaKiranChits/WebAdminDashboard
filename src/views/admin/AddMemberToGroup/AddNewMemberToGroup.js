...
export default function AddNewMemberToGroup() {
    return (
      <>
          ...
          <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
            <form>
              ...
              <div className="flex flex-wrap">
                <GroupFormInput placeholder={"Customer ID"} labelName={"Customer ID"} type="text" />
                <GroupFormInput placeholder={"Group ID"} labelName={"Group ID"} type="text" />
                <GroupFormInput placeholder={"Ticket No."} labelName={"Ticket No."} type="number" />
              </div>
